...
function SignIn(){
    ...
    return (
        <div id="sign-in" >
            <div id="signIn-bg" className="w-full flex justify-end max-lg:justify-center bg-linear-to-b from-[#077A7D] via-[#7AE2CF] to-[#F5EEDD]" >
                <div id="row" data-aos='zoom-in' data-aos-duration='800' className="flex w-2/5 max-lg:w-4/5 aspect-[7/6] m-10">
                    ...
                    className="border w-1/2 order-1 flex justify-center items-center px-7 py-5 bg-gray-100">
                    ...
                    className={`border w-1/2 order-2 bg-cover-set bg-[url('/images/winter.jpg')]`} ></motion.div>
                    {/* End img side */}
