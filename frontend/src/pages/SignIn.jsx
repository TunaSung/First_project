...
function SignIn(){
    ...
    return (
        <div id="sign-in" >
            <div id="signIn-bg" className="w-full flex justify-center max-lg:justify-center bg-linear-to-b from-[var(--tertiary-color)] via-[var(--secondary-color)] to-[var(--primary-color)]" >
                <div id="row" data-aos='zoom-in' data-aos-duration='800' className="flex w-2/5 max-lg:w-4/5 aspect-[7/6] m-10 rounded-2xl overflow-hidden">
                    {/* Start input side */}
                    <motion.div id="input"
                    ...
                    className="w-1/2 order-1 flex justify-center items-center px-7 py-5 bg-gray-100">
